...
const ChildFeedPage = () => {
      ...
      <div className="bg-white/10 backdrop-blur-2xl w-full max-w-md rounded-[40px] overflow-hidden shadow-[0_0_50px_rgba(14,165,233,0.3)] border border-white/20 animate-in zoom-in-95 duration-300">
        <div className="p-8 text-center font-sans">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            <div className="bg-sky-500/10 p-3 rounded-2xl flex items-center gap-3 border border-sky-400/20">
              <FiSmile className="text-sky-400" />
              <div className="text-left">
                <p className="text-[10px] text-sky-300 font-bold uppercase tracking-tighter">상태</p>
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-[#0b0f1a] flex items-center justify-center font-sans">
        <div className="text-sky-400 font-bold animate-pulse text-xl tracking-widest uppercase">Dream Traveling...</div>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#0b0f1a] bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] p-6 flex flex-col items-center overflow-x-hidden font-sans">
      ...
      <header className="w-full max-w-4xl flex justify-between items-center mb-12">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-sky-200 to-sky-400 uppercase tracking-[0.2em]">
            Dream Journey
          </h1>
      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full max-w-4xl">
        <div className="relative w-64 h-64 mb-16 flex justify-center items-center">
          <div className="absolute inset-0 bg-sky-500/20 blur-[80px] rounded-full animate-pulse"></div>
          <div className="relative z-10 drop-shadow-[0_0_20px_rgba(14,165,233,0.5)] animate-float w-full h-full">
        ...
        <div className="bg-white/5 backdrop-blur-xl p-8 rounded-[50px] border border-white/10 w-full max-w-lg shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
          {!gameMode && !gameResult ? (
            <div className="py-12 text-center">
              ...
              <h2 className="text-2xl font-black text-white mb-3 tracking-tight tracking-tighter">꿈나라 입구에서 대기 중</h2>
            ...
            <div className="py-12 text-center">
              ...
              <h2 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-sky-100 tracking-tight">
                아기가 꿈을 꾸고 있어요...
              </h2>
              ...
              <section>
                <header className="flex items-center justify-between mb-5">
                   <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sky-200 font-black text-xs uppercase tracking-[0.15em]">누구와 함께할까요?</h3>
                   </div>
                   {isMe(roles.guide) ? (
                    <span className="px-3 py-1 bg-sky-500 text-slate-950 text-[10px] font-black rounded-full shadow-lg shadow-sky-500/20 uppercase tracking-tighter">내 역할: 인도자</span>
                   ) : (
                    <span className="px-3 py-1 bg-white/5 text-sky-300 text-[10px] font-black rounded-full border border-white/10 uppercase tracking-tighter">상대방: 인도자</span>
                   )}
                </header>
                <div className="grid grid-cols-3 gap-3">
                  {GUIDES.map((g) => (
                    ...
                    >
                      <div className="relative z-10 flex flex-col items-center gap-2">
                        ...
                        <span className={`text-[11px] font-black ${mySelection.guide === g.id ? "text-sky-300" : "text-white/40"}`}>
                          {g.name}
                        </span>
                      </div>
                      {partnerSelection.guide === g.id && (
