...
/**
 * [SYSTEM PRESET] 지하철 좌표 수집 자동화 스크립트 (line9)
...
async function run() {
  ...
  console.log(`[START] Fetching coordinates for line9 (${target_stations.length} stations)`);
  let out = {};
  ...
  if (Object.keys(out).length === 0) {
    console.log(`[DONE] No new stations for line9.`);
    return;
  }
