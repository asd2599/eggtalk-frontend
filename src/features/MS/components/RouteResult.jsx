    ...
    <div className="relative w-full flex flex-col gap-5 pointer-events-auto bg-white dark:bg-slate-950 pb-6">
      ...
      <div className="flex justify-between items-center px-6 pt-10 md:pt-6 md:px-1">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg md:text-base font-black text-slate-800 dark:text-white tracking-tight">
              여정 상세
            </h3>
            <p className="text-[10px] md:text-[8px] text-sky-500 font-bold uppercase tracking-[0.2em]">
              Step by Step
            </p>
          </div>
        </div>
        ...
        <div className="bg-slate-900 rounded-[2.5rem] md:rounded-[2rem] p-7 md:p-6 text-white shadow-xl relative overflow-hidden border border-white/5">
          ...
          <div className="flex justify-between items-end mb-4">
            <div className="flex flex-col">
              ...
              <span className="text-5xl md:text-4xl font-black leading-none flex items-baseline">
                {result.totalTime}
                <small className="text-xl md:text-lg ml-1 font-bold text-sky-400">
                  min
                </small>
              </span>
            </div>
            <div className="text-right">
              <span className="block text-[11px] md:text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">
                Arrival
              </span>
              <span className="text-xl md:text-lg font-black text-white">
                {arrivalTimeStr}
              </span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center text-[12px] md:text-[11px] border-t border-white/10 pt-4">
            <div className="flex flex-col gap-0.5">
              ...
              <span className="font-black text-base md:text-sm text-sky-300">
                ₩{fareStr}
              </span>
            </div>
            ...
            return (
              ...
              >
                ...
                {index < result.timeline.length - 1 && (
                  <div className="absolute left-[36px] md:left-[23px] top-11 md:top-9 bottom-[-20px] md:bottom-[-12px] w-[3px] md:w-[2px] rounded-full bg-slate-100 dark:bg-slate-800 group-hover:bg-sky-200 transition-colors" />
                )}
                ...
                <div className="flex flex-col items-center z-10">
                  <div
                    ...
                    style={{
                      backgroundColor: isWalk ? '#f1f5f9' : stepColor,
                      color: isWalk ? '#94a3b8' : 'white',
                    }}
                  >
